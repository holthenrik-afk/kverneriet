...
def venue_faq(v):
    ...
    q = [
        ...
        (f'faq.{slug}.gluten', 'Er friesene glutenfrie?',
         'Ja. Friesene våre er trippelkokte, håndlagde og naturlig glutenfrie. Glutenfritt burgerbrød kan velges for +15 kr (inneholder glutenfri hvetestivelse). Alle retter er merket med allergener i menyen.',
         'Are the fries gluten-free?',
         'Yes. Our fries are triple-cooked, handmade and naturally gluten-free. A gluten-free bun is available for +NOK 15 (contains gluten-free wheat starch). Every dish is labelled with allergens on the menu.'),
    ]
    if rng:
...
def _general_faq():
    ...
    return [
        ...
        ('faq.g.book', 'Hvordan booker jeg bord hos Kverneriet?',
         'Trykk «Book bord», velg restaurant og book online med bekreftelse med en gang. Grupper over 8 (7 i Tønsberg) sender en forespørsel og velger matpakke for bordet. Alle restaurantene har også drop-in-bord.',
         'How do I book a table at Kverneriet?',
         'Press “Book a table”, choose a restaurant and book online with instant confirmation. Groups larger than 8 (7 in Tønsberg) send a request and choose a food package for the table. All three restaurants also keep walk-in tables.'),
        ...
        ('faq.g.why', 'Hva gjør burgerne til Kverneriet spesielle?',
         'Vi kverner alt kjøttet selv av storfe i toppklasse og steker burgerne medium pluss. Friesene er håndlagde, trippelkokte og tar tre dager å lage – og de er naturlig glutenfrie. Take-away-emballasjen er designet av oss i naturmaterialer.',
         'What makes Kverneriet’s burgers special?',
         'We grind all the beef ourselves from top-grade cattle and cook the burgers medium plus. The fries are handmade, triple-cooked and take three days – and they are naturally gluten-free. Our take-away packaging is our own design, in natural materials.'),
    ]
